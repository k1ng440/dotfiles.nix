...
func main() {
	...
	// This does not work because of semantic tokens by LSP and treesitter highlighting sucks and treesitter highlighting sucks.
	myQuery := /*sqlx*/ "SELECT * FROM whatever"
	_ = myQuery
