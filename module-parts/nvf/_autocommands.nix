_: {
  vim.luaConfigRC.autocommands = ''
    ...
    vim.api.nvim_create_autocmd('FileType', {
      ...
      pattern = {
        'NvimTree', 'PlenaryTestPopup', 'Trouble', 'checkhealth', 'copilot',
        'dap-float', 'fugitive', 'help', 'lspinfo', 'man', 'neo-tree',
        'neotest-output', 'neotest-output-panel', 'neotest-summary',
        'netrw', 'notify', 'qf', 'spectre_panel', 'startuptime', 'tsplayground',
      },
    ...
    -- Notify when file is changed on disk
