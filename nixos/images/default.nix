      ...
      xenomorph-iso-image = nixos-generators.nixosGenerate {
        ...
        modules = [
          ...
          ({
            ...
            disko-mount =
              pkgs.writeShellScriptBin "disko-mount"
              "${config.system.build.mountScript}";
            disko-format =
              pkgs.writeShellScriptBin "disko-format"
              "${config.system.build.formatScript}";

            # system
            system =
              self.nixosConfigurations.xenomorph.config.system.build.toplevel;
          ...
          in {
            ...
            environment.systemPackages = [disko disko-mount disko-format install-system];
